...
<title>武研图书角-<s:property value="#request.bookname"/></title>
<SCRIPT> 
...
function changeclo(obj){ 
	...
	var lab = document.getElementsByName('lastnumber'); 

	for (var i = 0; i < lab.length; i++) 
	{ 
		lab[i].className="lablecss1";
	} 

	obj.className="lablecss2"; 
	} 
...
<s:if test="#request.bookList!=null && #request.bookList.size()>0">
	...
	<input type="hidden" style="background-image: url(images/all.png)">
	</div>
...
<div id="bottomnav" > 
	  ...
	  <div class="borrowdiv">
	    ...
	    <input type="button" class="borrowbutton" value="借书" onclick="borrow()">
	   
	  </div>

	<div class="backdiv">
		<input type="button" class="backbutton" value="还书" onclick="back()">
	</div>
