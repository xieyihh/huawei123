...
<head>
   ...
   <script type="text/javascript" src="js/myJs/changephysicalinfo.js?v1.2.1"></script>
  <!-- 日历 -->
		...
		<form id="Form2" name="Form2"  method="post" enctype="multipart/form-data" class="form-inline"style="width:95%;margin:0 auto">	
			<div style="width:90%;margin:0 auto;">
				...
				<!--  <div class="form-group inputfix">
				 ...
				 <div class="form-group inputfix">
				    <label class="sr-only" for="Applydate">申请日期</label>
				    <input type="text" class="form-control" id="Applydate" placeholder="安排体检日期"onfocus="WdatePicker({skin:'ext',lang:'zh-cn',dateFmt:'yyyy-MM-dd'})"/>
				 </div>		-->
