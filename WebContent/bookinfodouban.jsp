...
<div data-role="page" id="pageone">
  ...
  <div data-role="content" >
	...
	<s:form id="borrowform" method="post" action="scanbook.action">
  		<input type="hidden" name="onlysign" id="onlysign" value="<s:property value="#request.bookList.onlysign"/>"/>
	  </s:form>
	  <s:form id="backform" method="post" action="clickbackbook.action">
  		<input type="hidden" name="onlysign" id="onlysign" value="<s:property value="#request.bookList.onlysign"/>"/>
	  </s:form>
	</div>
      <div data-role="navbar">
      <ul>      
        <li><a onclick="document.getElementById('borrowform').submit()"  data-icon="forward">借阅</a></li>
        <li><a  onclick="document.getElementById('backform').submit()"  data-icon="back">还书</a></li>
      </ul>
    </div>  
