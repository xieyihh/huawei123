...
<!-- 	<script src="bootstrap/bootstrap.min.js"></script>
   ...
   <script type="text/javascript" src="js/body.js"></script> -->
		...
		<script type="text/javascript" src="js/body.js"></script>
   	<script type="text/javascript" src="js/myJs/importbook.js?v1.1.3"></script>
...
width:100%;height:100px}
 ...
 <div style="height: 30px;background: url(images/bg01.gif);margin-top:-15px;">
		...
		<div class="main_content">
  		...
  		<form id="bookForm" name="hospitalForm" action="importbook.action" method="post" enctype="multipart/form-data" class="form-inline"style="width:95%;margin:0 auto;">	
			<div style="width:85%;margin:0 auto;">
				
				<div class="form-group" style="color:#bbb;width:100%">
				    <p class="form-control-static"  >选择书籍信息csv文件，批量导入书籍信息</p>
				 </div>
				 ...
				 <button type="button" class="btn btn-primary " id="batchData" >批量导入</button>
				  <button type="button" class="btn btn-success " id="downloadBookTemplates" title="导入前请先下载模板核对格式要求" >下载模版</button>
			</div> 
